...
`sw-superpower` は [Kimi Code CLI](https://github.com/MoonshotAI/kimi-code) 向けに設計された Superpowers スタイルのスキルセットです。熟成されたソフトウェアエンジニアリングの実践（TDD、コードレビュー、体系的なデバッグ）を構造化され再利用可能なエージェントスキルとしてカプセル化しています。
...
| **sw-code-review** | 二段階のコードレビュー | タスクまたは機能の完了後 |
...
2. Kimi Code CLI を再起動するか、スキルをリロードします。
